...
#define dalloc(arr, len) cudaMallocManaged((void**)&(arr), (len)*sizeof(double))
#define dfree(arr) cudaFree(arr)
...
#define dalloc(arr, len) hipMalloc((void**)&(arr), (len)*sizeof(double))
#define dfree(arr) hipFree(arr)
#define dcopy(dst, src, len) hipMemcpy(dst, src, (len)*sizeof(double), hipMemcpyHostToDevice)
#else
#define HIP_OR_CUDA(a,b) ((void)0);
#define dalloc(arr, len) arr = (double *) malloc((len)*sizeof(double))
#define dfree(arr) free(arr)
...
cvklu_data *cvklu_setup_data(const char *FileLocation, long int ncells, SUNMemoryHelper memhelper)
{
  ...
  dalloc(data->Ts, ncells);
  dalloc(data->dTs_ge, ncells);
  dalloc(data->mdensity, ncells);
  dalloc(data->inv_mdensity, ncells);
  dalloc(data->rs_k01, ncells);
  dalloc(data->drs_k01, ncells);
  dalloc(data->rs_k02, ncells);
  dalloc(data->drs_k02, ncells);
  dalloc(data->rs_k03, ncells);
  dalloc(data->drs_k03, ncells);
  dalloc(data->rs_k04, ncells);
  dalloc(data->drs_k04, ncells);
  dalloc(data->rs_k05, ncells);
  dalloc(data->drs_k05, ncells);
  dalloc(data->rs_k06, ncells);
  dalloc(data->drs_k06, ncells);
  dalloc(data->rs_k07, ncells);
  dalloc(data->drs_k07, ncells);
  dalloc(data->rs_k08, ncells);
  dalloc(data->drs_k08, ncells);
  dalloc(data->rs_k09, ncells);
  dalloc(data->drs_k09, ncells);
  dalloc(data->rs_k10, ncells);
  dalloc(data->drs_k10, ncells);
  dalloc(data->rs_k11, ncells);
  dalloc(data->drs_k11, ncells);
  dalloc(data->rs_k12, ncells);
  dalloc(data->drs_k12, ncells);
  dalloc(data->rs_k13, ncells);
  dalloc(data->drs_k13, ncells);
  dalloc(data->rs_k14, ncells);
  dalloc(data->drs_k14, ncells);
  dalloc(data->rs_k16, ncells);
  dalloc(data->drs_k16, ncells);
  dalloc(data->rs_k17, ncells);
  dalloc(data->drs_k17, ncells);
  dalloc(data->rs_k18, ncells);
  dalloc(data->drs_k18, ncells);
  dalloc(data->rs_k19, ncells);
  dalloc(data->drs_k19, ncells);
  dalloc(data->rs_k21, ncells);
  dalloc(data->drs_k21, ncells);
  dalloc(data->rs_k22, ncells);
  dalloc(data->drs_k22, ncells);
  dalloc(data->cs_brem_brem, ncells);
  dalloc(data->dcs_brem_brem, ncells);
  dalloc(data->cs_ceHeI_ceHeI, ncells);
  dalloc(data->dcs_ceHeI_ceHeI, ncells);
  dalloc(data->cs_ceHeII_ceHeII, ncells);
  dalloc(data->dcs_ceHeII_ceHeII, ncells);
  dalloc(data->cs_ceHI_ceHI, ncells);
  dalloc(data->dcs_ceHI_ceHI, ncells);
  dalloc(data->cs_cie_cooling_cieco, ncells);
  dalloc(data->dcs_cie_cooling_cieco, ncells);
  dalloc(data->cs_ciHeI_ciHeI, ncells);
  dalloc(data->dcs_ciHeI_ciHeI, ncells);
  dalloc(data->cs_ciHeII_ciHeII, ncells);
  dalloc(data->dcs_ciHeII_ciHeII, ncells);
  dalloc(data->cs_ciHeIS_ciHeIS, ncells);
  dalloc(data->dcs_ciHeIS_ciHeIS, ncells);
  dalloc(data->cs_ciHI_ciHI, ncells);
  dalloc(data->dcs_ciHI_ciHI, ncells);
  dalloc(data->cs_compton_comp_, ncells);
  dalloc(data->dcs_compton_comp_, ncells);
  dalloc(data->cs_gloverabel08_gael, ncells);
  dalloc(data->dcs_gloverabel08_gael, ncells);
  dalloc(data->cs_gloverabel08_gaH2, ncells);
  dalloc(data->dcs_gloverabel08_gaH2, ncells);
  dalloc(data->cs_gloverabel08_gaHe, ncells);
  dalloc(data->dcs_gloverabel08_gaHe, ncells);
  dalloc(data->cs_gloverabel08_gaHI, ncells);
  dalloc(data->dcs_gloverabel08_gaHI, ncells);
  dalloc(data->cs_gloverabel08_gaHp, ncells);
  dalloc(data->dcs_gloverabel08_gaHp, ncells);
  dalloc(data->cs_gloverabel08_h2lte, ncells);
  dalloc(data->dcs_gloverabel08_h2lte, ncells);
  dalloc(data->cs_h2formation_h2mcool, ncells);
  dalloc(data->dcs_h2formation_h2mcool, ncells);
  dalloc(data->cs_h2formation_h2mheat, ncells);
  dalloc(data->dcs_h2formation_h2mheat, ncells);
  dalloc(data->cs_h2formation_ncrd1, ncells);
  dalloc(data->dcs_h2formation_ncrd1, ncells);
  dalloc(data->cs_h2formation_ncrd2, ncells);
  dalloc(data->dcs_h2formation_ncrd2, ncells);
  dalloc(data->cs_h2formation_ncrn, ncells);
  dalloc(data->dcs_h2formation_ncrn, ncells);
  dalloc(data->cs_reHeII1_reHeII1, ncells);
  dalloc(data->dcs_reHeII1_reHeII1, ncells);
  dalloc(data->cs_reHeII2_reHeII2, ncells);
  dalloc(data->dcs_reHeII2_reHeII2, ncells);
  dalloc(data->cs_reHeIII_reHeIII, ncells);
  dalloc(data->dcs_reHeIII_reHeIII, ncells);
  dalloc(data->cs_reHII_reHII, ncells);
  dalloc(data->dcs_reHII_reHII, ncells);
  dalloc(data->cie_optical_depth_approx, ncells);
  dalloc(data->h2_optical_depth_approx, ncells);

  // allocate scaling arrays
  dalloc(data->scale, NSPECIES*ncells);
  dalloc(data->inv_scale, NSPECIES*ncells);
  data->current_z = 0.0;
  ...
  dalloc(data->r_k01, data->nbins+1);
  dalloc(data->r_k02, data->nbins+1);
  dalloc(data->r_k03, data->nbins+1);
  dalloc(data->r_k04, data->nbins+1);
  dalloc(data->r_k05, data->nbins+1);
  dalloc(data->r_k06, data->nbins+1);
  dalloc(data->r_k07, data->nbins+1);
  dalloc(data->r_k08, data->nbins+1);
  dalloc(data->r_k09, data->nbins+1);
  dalloc(data->r_k10, data->nbins+1);
  dalloc(data->r_k11, data->nbins+1);
  dalloc(data->r_k12, data->nbins+1);
  dalloc(data->r_k13, data->nbins+1);
  dalloc(data->r_k14, data->nbins+1);
  dalloc(data->r_k15, data->nbins+1);
  dalloc(data->r_k16, data->nbins+1);
  dalloc(data->r_k17, data->nbins+1);
  dalloc(data->r_k18, data->nbins+1);
  dalloc(data->r_k19, data->nbins+1);
  dalloc(data->r_k21, data->nbins+1);
  dalloc(data->r_k22, data->nbins+1);
  dalloc(data->c_brem_brem, data->nbins+1);
  dalloc(data->c_ceHeI_ceHeI, data->nbins+1);
  dalloc(data->c_ceHeII_ceHeII, data->nbins+1);
  dalloc(data->c_ceHI_ceHI, data->nbins+1);
  dalloc(data->c_cie_cooling_cieco, data->nbins+1);
  dalloc(data->c_ciHeI_ciHeI, data->nbins+1);
  dalloc(data->c_ciHeII_ciHeII, data->nbins+1);
  dalloc(data->c_ciHeIS_ciHeIS, data->nbins+1);
  dalloc(data->c_ciHI_ciHI, data->nbins+1);
  dalloc(data->c_compton_comp_, data->nbins+1);
  dalloc(data->c_gloverabel08_gael, data->nbins+1);
  dalloc(data->c_gloverabel08_gaH2, data->nbins+1);
  dalloc(data->c_gloverabel08_gaHe, data->nbins+1);
  dalloc(data->c_gloverabel08_gaHI, data->nbins+1);
  dalloc(data->c_gloverabel08_gaHp, data->nbins+1);
  dalloc(data->c_gloverabel08_h2lte, data->nbins+1);
  dalloc(data->c_h2formation_h2mcool, data->nbins+1);
  dalloc(data->c_h2formation_h2mheat, data->nbins+1);
  dalloc(data->c_h2formation_ncrd1, data->nbins+1);
  dalloc(data->c_h2formation_ncrd2, data->nbins+1);
  dalloc(data->c_h2formation_ncrn, data->nbins+1);
  dalloc(data->c_reHeII1_reHeII1, data->nbins+1);
  dalloc(data->c_reHeII2_reHeII2, data->nbins+1);
  dalloc(data->c_reHeIII_reHeIII, data->nbins+1);
  dalloc(data->c_reHII_reHII, data->nbins+1);
  dalloc(data->g_gammaH2_1, data->nbins+1);
  dalloc(data->g_dgammaH2_1_dT, data->nbins+1);
  dalloc(data->g_gammaH2_2, data->nbins+1);
  dalloc(data->g_dgammaH2_2_dT, data->nbins+1);

  /* read tables from HDF5 files */
...
void cvklu_free_data(void *data, SUNMemoryHelper memhelper)
{
  ...
  dfree(rxdata->scale);
  dfree(rxdata->inv_scale);
  dfree(rxdata->Ts);
  dfree(rxdata->dTs_ge);
  dfree(rxdata->mdensity);
  dfree(rxdata->inv_mdensity);
  dfree(rxdata->rs_k01);
  dfree(rxdata->drs_k01);
  dfree(rxdata->rs_k02);
  dfree(rxdata->drs_k02);
  dfree(rxdata->rs_k03);
  dfree(rxdata->drs_k03);
  dfree(rxdata->rs_k04);
  dfree(rxdata->drs_k04);
  dfree(rxdata->rs_k05);
  dfree(rxdata->drs_k05);
  dfree(rxdata->rs_k06);
  dfree(rxdata->drs_k06);
  dfree(rxdata->rs_k07);
  dfree(rxdata->drs_k07);
  dfree(rxdata->rs_k08);
  dfree(rxdata->drs_k08);
  dfree(rxdata->rs_k09);
  dfree(rxdata->drs_k09);
  dfree(rxdata->rs_k10);
  dfree(rxdata->drs_k10);
  dfree(rxdata->rs_k11);
  dfree(rxdata->drs_k11);
  dfree(rxdata->rs_k12);
  dfree(rxdata->drs_k12);
  dfree(rxdata->rs_k13);
  dfree(rxdata->drs_k13);
  dfree(rxdata->rs_k14);
  dfree(rxdata->drs_k14);
  dfree(rxdata->rs_k15);
  dfree(rxdata->drs_k15);
  dfree(rxdata->rs_k16);
  dfree(rxdata->drs_k16);
  dfree(rxdata->rs_k17);
  dfree(rxdata->drs_k17);
  dfree(rxdata->rs_k18);
  dfree(rxdata->drs_k18);
  dfree(rxdata->rs_k19);
  dfree(rxdata->drs_k19);
  dfree(rxdata->rs_k21);
  dfree(rxdata->drs_k21);
  dfree(rxdata->rs_k22);
  dfree(rxdata->drs_k22);
  dfree(rxdata->cs_brem_brem);
  dfree(rxdata->dcs_brem_brem);
  dfree(rxdata->cs_ceHeI_ceHeI);
  dfree(rxdata->dcs_ceHeI_ceHeI);
  dfree(rxdata->cs_ceHeII_ceHeII);
  dfree(rxdata->dcs_ceHeII_ceHeII);
  dfree(rxdata->cs_ceHI_ceHI);
  dfree(rxdata->dcs_ceHI_ceHI);
  dfree(rxdata->cs_cie_cooling_cieco);
  dfree(rxdata->dcs_cie_cooling_cieco);
  dfree(rxdata->cs_ciHeI_ciHeI);
  dfree(rxdata->dcs_ciHeI_ciHeI);
  dfree(rxdata->cs_ciHeII_ciHeII);
  dfree(rxdata->dcs_ciHeII_ciHeII);
  dfree(rxdata->cs_ciHeIS_ciHeIS);
  dfree(rxdata->dcs_ciHeIS_ciHeIS);
  dfree(rxdata->cs_ciHI_ciHI);
  dfree(rxdata->dcs_ciHI_ciHI);
  dfree(rxdata->cs_compton_comp_);
  dfree(rxdata->dcs_compton_comp_);
  dfree(rxdata->cs_gloverabel08_gael);
  dfree(rxdata->dcs_gloverabel08_gael);
  dfree(rxdata->cs_gloverabel08_gaH2);
  dfree(rxdata->dcs_gloverabel08_gaH2);
  dfree(rxdata->cs_gloverabel08_gaHe);
  dfree(rxdata->dcs_gloverabel08_gaHe);
  dfree(rxdata->cs_gloverabel08_gaHI);
  dfree(rxdata->dcs_gloverabel08_gaHI);
  dfree(rxdata->cs_gloverabel08_gaHp);
  dfree(rxdata->dcs_gloverabel08_gaHp);
  dfree(rxdata->cs_gloverabel08_h2lte);
  dfree(rxdata->dcs_gloverabel08_h2lte);
  dfree(rxdata->cs_h2formation_h2mcool);
  dfree(rxdata->dcs_h2formation_h2mcool);
  dfree(rxdata->cs_h2formation_h2mheat);
  dfree(rxdata->dcs_h2formation_h2mheat);
  dfree(rxdata->cs_h2formation_ncrd1);
  dfree(rxdata->dcs_h2formation_ncrd1);
  dfree(rxdata->cs_h2formation_ncrd2);
  dfree(rxdata->dcs_h2formation_ncrd2);
  dfree(rxdata->cs_h2formation_ncrn);
  dfree(rxdata->dcs_h2formation_ncrn);
  dfree(rxdata->cs_reHeII1_reHeII1);
  dfree(rxdata->dcs_reHeII1_reHeII1);
  dfree(rxdata->cs_reHeII2_reHeII2);
  dfree(rxdata->dcs_reHeII2_reHeII2);
  dfree(rxdata->cs_reHeIII_reHeIII);
  dfree(rxdata->dcs_reHeIII_reHeIII);
  dfree(rxdata->cs_reHII_reHII);
  dfree(rxdata->dcs_reHII_reHII);
  dfree(rxdata->cie_optical_depth_approx);
  dfree(rxdata->h2_optical_depth_approx);
  dfree(rxdata->r_k01);
  dfree(rxdata->r_k02);
  dfree(rxdata->r_k03);
  dfree(rxdata->r_k04);
  ...
  dfree(rxdata->r_k21);
  dfree(rxdata->r_k22);
  dfree(rxdata->c_brem_brem);
  dfree(rxdata->c_ceHeI_ceHeI);
  dfree(rxdata->c_ceHeII_ceHeII);
  dfree(rxdata->c_ceHI_ceHI);
  dfree(rxdata->c_cie_cooling_cieco);
  dfree(rxdata->c_ciHeI_ciHeI);
  dfree(rxdata->c_ciHeII_ciHeII);
  dfree(rxdata->c_ciHeIS_ciHeIS);
  dfree(rxdata->c_ciHI_ciHI);
  dfree(rxdata->c_compton_comp_);
  dfree(rxdata->c_gloverabel08_gael);
  dfree(rxdata->c_gloverabel08_gaH2);
  dfree(rxdata->c_gloverabel08_gaHe);
  dfree(rxdata->c_gloverabel08_gaHI);
  dfree(rxdata->c_gloverabel08_gaHp);
  dfree(rxdata->c_gloverabel08_h2lte);
  dfree(rxdata->c_h2formation_h2mcool);
  dfree(rxdata->c_h2formation_h2mheat);
  dfree(rxdata->c_h2formation_ncrd1);
  dfree(rxdata->c_h2formation_ncrd2);
  dfree(rxdata->c_h2formation_ncrn);
  dfree(rxdata->c_reHeII1_reHeII1);
  dfree(rxdata->c_reHeII2_reHeII2);
  dfree(rxdata->c_reHeIII_reHeIII);
  dfree(rxdata->c_reHII_reHII);
  dfree(rxdata->g_gammaH2_1);
  dfree(rxdata->g_dgammaH2_1_dT);
  dfree(rxdata->g_gammaH2_2);
  dfree(rxdata->g_dgammaH2_2_dT);
  dfree(rxdata);
}
